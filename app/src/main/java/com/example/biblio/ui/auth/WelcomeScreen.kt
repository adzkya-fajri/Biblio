...
fun WelcomeScreenContent
    ...
    Box(
        ...
        Column(
            horizontalAlignment = Alignment.CenterHorizontally,   // tetep center HORIZONTAL
            verticalArrangement = Arrangement.Center,              // item di dalam Column tetap center
            modifier = Modifier
                .fillMaxWidth()
                .align(Alignment.BottomCenter)                    // ⬅️ Columnnya pindah ke bawah
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(
                    containerColor = colorResource(id = R.color.colorPrimaryVariant),
